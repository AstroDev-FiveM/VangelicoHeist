...
RegisterNetEvent("astro-heist:glass1", function()
    ...
    else exports['Astro-NotifySystem']:Notify('error', 'Nie masz czym tego rozbić!') end else exports['Astro-NotifySystem']:Notify('error', 'Nic tu nie ma!') end end)
...
exports['ps-ui']:VarHack(function(success)
    if success then
        ...
        TriggerServerEvent('astro-heist:deleteitem', Config.HackItem)
    else
        exports['Astro-NotifySystem']:Notify('error', 'Spróbuj ponownie!')
    end
 end, 5, 5) end)
